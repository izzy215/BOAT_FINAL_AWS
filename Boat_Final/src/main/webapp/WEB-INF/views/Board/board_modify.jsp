...
<body>
	...
	<div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
		<div class="container text-center py-5">
			<h1 class="display-4 text-white animated slideInDown mb-3">업무게시판 - 수정</h1>
...
<sec:authentication property="principal" var="pinfo"/>
	...
	<div class="container mt-5">
		<form action = "${pageContext.request.contextPath}/board/modifyAction" method="post" enctype="multipart/form-data" name="boardform" id="boardform">
		<input type="hidden" name="BOARD_NUM" value="${boarddata.BOARD_NUM }">
		<h2 class="text-center">업무 게시판 - 수정</h2>
		 
			<div class="form-group">
				<label for="board_subject">제목</label>
				 <input	name="BOARD_SUBJECT" id="board_subject"  maxlength="50" class="form-control"  value="${boarddata.BOARD_SUBJECT }">
			</div>
			<input type ="hidden" name ="BOARD_EMPNO" value="${boarddata.BOARD_EMPNO}">
			...
			<div class="form-group row">
				...
				<input type="text" class="form-control" id="board_job" name="BOARD_JOB" value="${boarddata.BOARD_JOB}" readonly>
				</label>
			
			
			
				 <label for="board_name" class="col-sm-2 col-form-label">이름
				 <input	type="text" class="form-control" id="board_name" name="BOARD_NAME" value="${boarddata.BOARD_NAME}" readonly>
				 </label>
			...
			<textarea class="form-control board_content" id="summernote" name="BOARD_CONTENT" >${boarddata.BOARD_CONTENT }</textarea>
			</div>
